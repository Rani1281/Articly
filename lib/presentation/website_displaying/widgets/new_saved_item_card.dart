...
class NewSavedItemCard extends StatefulWidget {
  const NewSavedItemCard({
    super.key,
  ...
  @override
  State<NewSavedItemCard> createState() => _NewSavedItemCardState();
}

class _NewSavedItemCardState extends State<NewSavedItemCard> {
  ...
  @override
  void didUpdateWidget(covariant NewSavedItemCard oldWidget) {
    super.didUpdateWidget(oldWidget);

    _isGridView = widget.isGridView;

    if (oldWidget.viewModel != widget.viewModel) {
      oldWidget.viewModel.removeListener(_checkDeletion);
      _viewModel = widget.viewModel;
      _viewModel.addListener(_checkDeletion);
    }
  }
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            //       ClipboardData(text: item.uri.toString()),
                            //     );
                            //     // TODO: change url copied
                            //   },
                            // ),
                          ],
                        ),
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: item.imageUrl != null
                      ...
                      // TODO: add a default image asset
